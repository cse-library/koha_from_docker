...
<xsl:if test="$DisplayIconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img title="Sách" alt="Sách" src="/intranet-tmpl/prog/img/famfamfam/silk/book_link.png" class="materialtype" /> Bộ</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" class="materialtype" title="Sách" alt="Sách" /> Sách</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'"><img class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/newspaper.png" alt="ÂPĐK" title="ÂPĐK" /> Continuing resource</xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'"><img class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/book_open.png" alt="Bài báo" title="Bài báo" /> Bài báo</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'"><img class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" alt="Sách" title="Sách" /> Sách</xsl:when>
 <xsl:when test="$leader6='o'"><img title="Bộ công cụ" alt="Bộ công cụ" src="/intranet-tmpl/prog/img/famfamfam/silk/report_disk.png" class="materialtype" /> Bộ công cụ</xsl:when>
 <xsl:when test="$leader6='p'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/report_disk.png" class="materialtype" title="Vật liệu hỗn hợp" alt="Vật liệu hỗn hợp" />Vật liệu hỗn hợp</xsl:when>
 <xsl:when test="$leader6='m'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/computer_link.png" class="materialtype" title="File máy tính" alt="File máy tính" /> File máy tính</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img title="Bản đồ" alt="Bản đồ" src="/intranet-tmpl/prog/img/famfamfam/silk/map.png" class="materialtype" /> Bản đồ</xsl:when>
 <xsl:when test="$leader6='g' or $leader6='k' or $leader6='r'"><img title="Visual material" alt="Visual material" src="/intranet-tmpl/prog/img/famfamfam/silk/film.png" class="materialtype" /> Visual material</xsl:when>
 ...
 <xsl:when test="$leader6='i'"><img alt="Âm nhạc" title="Âm nhạc" class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/sound.png" /> Âm nhạc</xsl:when>
 <xsl:when test="$leader6='j'"><img title="Âm nhạc" alt="Âm nhạc" src="/intranet-tmpl/prog/img/famfamfam/silk/sound.png" class="materialtype" /> Âm nhạc</xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
