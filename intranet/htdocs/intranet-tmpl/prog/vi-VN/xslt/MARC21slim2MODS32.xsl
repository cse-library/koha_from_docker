...
-->
 ...
 <role>
 <roleTerm authority="marcrelator" type="text">Tác giả:</roleTerm>
 </role>
 ...
 <xsl:attribute name="collection">Có</xsl:attribute>
 </xsl:if>
 <xsl:if test="$leader6='d' or $leader6='f' or $leader6='p' or $leader6='t'">
 <xsl:attribute name="manuscript">Có</xsl:attribute>
 </xsl:if>
 <xsl:choose>
 <xsl:when test="$leader6='a' or $leader6='t'">Văn bản</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'">cartographic</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'">Ký hiệu âm nhạc</xsl:when>
 <xsl:when test="$leader6='i'">Bản thu âm - Khác</xsl:when>
 <xsl:when test="$leader6='j'">Bản thi âm - Âm nhạc</xsl:when>
 <xsl:when test="$leader6='k'">still image</xsl:when>
 <xsl:when test="$leader6='g'">moving image</xsl:when>
 <xsl:when test="$leader6='r'">Đối tượng 3 chiều</xsl:when>
 <xsl:when test="$leader6='m'">Phần mềm, đa phương tiện</xsl:when>
 <xsl:when test="$leader6='p'">Vật liệu tổng hợp</xsl:when>
 </xsl:choose>
 </typeOfResource>
 ...
 <genre authority="marc">Bản đồ</genre>
 </xsl:when>
 ...
 <genre authority="marc">Cơ sở dữ liệu</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='l'">
 <genre authority="marc">loose-leaf</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='m'">
 <genre authority="marc">Tùng thư</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='n'">
 <genre authority="marc">Bài báo</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='p'">
 <genre authority="marc">Định kỳ</genre>
 </xsl:when>
 ...
 <genre authority="marc">Trừu tượng hoặc tóm tắt</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'b')">
 <genre authority="marc">Tiểu sử</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'c')">
 <genre authority="marc">Tìm kiếm</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'d')">
 <genre authority="marc">Từ điển</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'e')">
 <genre authority="marc">Bách khoa toàn thư</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'f')">
 <genre authority="marc">Sổ tay</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'g')">
 <genre authority="marc">Bài viết pháp lý</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'i')">
 <genre authority="marc">Chỉ số</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'k')">
 <genre authority="marc">Đĩa nhạc</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'l')">
 <genre authority="marc">Pháp luật</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'m')">
 <genre authority="marc">Luận án, luận văn</genre>
 </xsl:when>
 ...
 <genre authority="marc">Tài liệu lập trình</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'q')">
 <genre authority="marc">filmography</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'r')">
 <genre authority="marc">Thư mục</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'s')">
 <genre authority="marc">Thống kê</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'t')">
 <genre authority="marc">Báo cáo kỹ thuật</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'v')">
 <genre authority="marc">legal case and case notes</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'w')">
 <genre authority="marc">Báo cáo pháp luật</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'z')">
 <genre authority="marc">Hiệp ước</genre>
 </xsl:when>
 </xsl:choose>
 ...
 <genre authority="marc">Dữ liệu số</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='e'">
 <genre authority="marc">Cơ sở dữ liệu</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='f'">
 <genre authority="marc">Phông chữ</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <genre authority="marc">Trò chơi</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 <xsl:if test="$typeOf008='BK'">
 <xsl:if test="substring($controlField008,25,1)='j'">
 <genre authority="marc">Bằng sáng chế</genre>
 </xsl:if>
 ...
 <genre authority="marc">Hồi ký, tiểu sử</genre>
 </xsl:if>
 <xsl:variable name="controlField008-33" select="substring($controlField008,34,1)"></xsl:variable>
 <xsl:choose>
 <xsl:when test="$controlField008-33='e'">
 <genre authority="marc">Tiểu luận</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 <genre authority="marc">Kịch</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">comic strip</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">Viễn tưởng</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='h'">
 <genre authority="marc">Tryện cười</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">Thông báo</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">Tiểu thuyết</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='j'">
 <genre authority="marc">Truyện ngắn</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='s'">
 <genre authority="marc">Diễn văn, biện luận</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">Lịch sử tài liệu</genre>
 </xsl:if>
 ...
 <genre authority="marc">Thơ</genre>
 </xsl:if>
 ...
 <genre authority="marc">Âm nhạc</genre>
 </xsl:if>
 ...
 <genre authority="marc">nghệ thuật gốc</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='b'">
 <genre authority="marc">Bộ công cụ</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">nghệ thuật tái tạo</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 ...
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">Ảnh</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='k'">
 <genre authority="marc">Đồ họa</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">Bản vẽ kỹ thuật</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='m'">
 <genre authority="marc">Tranh hoạt họa</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='n'">
 <genre authority="marc">Biểu đồ</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='o'">
 <genre authority="marc">Thẻ nhớ</genre>
 </xsl:when>
 ...
 <genre authority="marc">Giấy trong</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='v'">
 <genre authority="marc">Băng ghi hình</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='w'">
 <genre authority="marc">Đồ chơi</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <place>
 <placeTerm>
 <xsl:attribute name="type">Mã</xsl:attribute>
 ...
 <place>
 <placeTerm>
 <xsl:attribute name="type">Văn bản</xsl:attribute>
 ...
 <issuance>
 <xsl:choose>
 <xsl:when test="$leader7='a' or $leader7='c' or $leader7='d' or $leader7='m'">Chuyên khảo</xsl:when>
 ...
 <digitalOrigin>Định dạng số</digitalOrigin>
 </xsl:if>
 <xsl:if test="$typeOf008='CF' and marc:controlfield[@tag=007][substring(.,12,1)='b']">
 <digitalOrigin>vi phim số</digitalOrigin>
 </xsl:if>
 <xsl:if test="$typeOf008='CF' and marc:controlfield[@tag=007][substring(.,12,1)='d']">
 <digitalOrigin>vi phim tương tự</digitalOrigin>
 </xsl:if>
 ...
 <form authority="marcform">Chữ nổi</form>
 </xsl:when>
 ...
 <form authority="marcform">Bản in</form>
 </xsl:when>
 <xsl:when test="$leader6 = 'm' or ($check008-23 and $controlField008-23='s') or ($check008-29 and $controlField008-29='s')">
 <form authority="marcform">Điện tử</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='b') or ($check008-29 and $controlField008-29='b')">
 <form authority="marcform">Vi thẻ</form>
 </xsl:when>
 ...
 <reformattingQuality>Truy cập</reformattingQuality>
 </xsl:when>
 ...
 <form authority="smd">Đĩa từ</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='m']">
 <form authority="smd">Đĩa từ - quang</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='o']">
 <form authority="smd">Đĩa quang</form>
 </xsl:if>
 ...
 <form authority="smd">Bộ công cụ</form>
 </xsl:if>
 
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='d']">
 <form authority="smd">Bản đồ</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='g']">
 <form authority="smd">Giản đồ</form>
 </xsl:if>
 ...
 <form authority="smd">Vi thẻ</form>
 </xsl:if>
 ...
 <form authority="smd">Biểu đồ</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='c']">
 <form authority="smd">Tranh dán</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='d']">
 <form authority="smd">Tranh họa tiết</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='o']">
 <form authority="smd">Thẻ nhớ</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='e']">
 <form authority="smd">Tranh vẽ</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='f']">
 <form authority="smd">In quang cơ</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='g']">
 <form authority="smd">Ảnh âm bản</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='h']">
 <form authority="smd">Tranh in</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='i']">
 <form authority="smd">Ảnh</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='j']">
 <form authority="smd">Bản in</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='l']">
 <form authority="smd">Bản vẽ kỹ thuật</form>
 </xsl:if>
 
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='q'][substring(text(),2,1)='q']">
 <form authority="smd">Ký hiệu âm nhạc</form>
 </xsl:if>
 ...
 <form authority="smd">Giấy trong</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='r'][substring(text(),2,1)='r']">
 <form authority="smd">remote-sensing image</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='e']">
 <form authority="smd">Hình trụ</form>
 </xsl:if>
 ...
 <form authority="smd">Đĩa nhạc</form>
 </xsl:if>
 ...
 <form authority="smd">Chữ nổi</form>
 </xsl:if>
 ...
 <form authority="smd">In khổ lớn</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='t'][substring(text(),2,1)='a']">
 <form authority="smd">In thường</form>
 </xsl:if>
 ...
 <targetAudience authority="marctarget">Thanh niên</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='e'">
 <targetAudience authority="marctarget">Người lớn</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='g'">
 <targetAudience authority="marctarget">Tổng hợp</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='b' or $controlField008-22='c' or $controlField008-22='j'">
 <targetAudience authority="marctarget">Vị thành niên</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='a'">
 <targetAudience authority="marctarget">Mầm non</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='f'">
 <targetAudience authority="marctarget">Chuyên ngành</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <xsl:with-param name="type">Số ISBN</xsl:with-param>
 </xsl:call-template>
 ...
 <xsl:call-template name="isInvalid">
 <xsl:with-param name="type">Số ISSN</xsl:with-param>
 </xsl:call-template>
 ...
 <xsl:attribute name="type">
 <xsl:choose>
 <xsl:when test="@ind1='0'">Số kỳ phát hành</xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="$scriptCode='(3'">Tiếng Ả Rập</xsl:when>
 <xsl:when test="$scriptCode='(B'">Hệ ngôn ngữ Latinh</xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="@code='b'">Tóm tắt hoặc nhan đề phụ</xsl:when>
 <xsl:when test="@code='d'">sung or spoken text</xsl:when>
 <xsl:when test="@code='e'">Thể loại nhạc kịch</xsl:when>
