...
<xsl:template match="marc:record">
 ...
 <xsl:with-param name="label">Lần xuất bản</xsl:with-param>
 ...
 <xsl:with-param name="spanclass">Tùng thư</xsl:with-param>
 </xsl:call-template>
 ...
 <xsl:with-param name="label">Chủ đề</xsl:with-param>
 </xsl:call-template>
